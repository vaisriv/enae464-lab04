"""
ENAE464 Lab04: Particle Imaging Velocimetry (PIV) Analysis
...
print("=" * 80)
print("ENAE464 Lab04: Particle Imaging Velocimetry Analysis")
print("=" * 80)
print()
...
print(f"PIV-measured mean velocities:")
...
print(f"  Re = (U∞ × D) / ν")
print(f"  Re = ({U_INF:.4f} × {CYLINDER_DIAMETER:.4f}) / {WATER_KINEMATIC_VISCOSITY:.6e}")
...
print(f"Point closest to origin:")
...
print(f"Saved velocity fluctuation data → {OUTPUT_TEXT_DIR / 'velocity_fluctuation.csv'}")
print()
...
print(f"Expected shedding frequency:")
print(f"  f = St × U∞ / D")
...
print(f"Saved expected frequency results → {OUTPUT_TEXT_DIR / 'expected_shedding_frequency.csv'}")
print()
...
print(f"Particle reaction time:")
print(f"  τ_r = ρ_p × D_p² / (18 × μ)")
print(f"  τ_r = {PARTICLE_DENSITY} × ({PARTICLE_DIAMETER:.2e})² / (18 × {WATER_VISCOSITY:.2e})")
...
print(f"Characteristic flow time scale:")
print(f"  τ_f = 1 / f_shedding")
...
print(f"Stokes number:")
print(f"  St_k = τ_r / τ_f")
...
print(f"Saved measured frequency results → {OUTPUT_TEXT_DIR / 'measured_shedding_frequency.csv'}")
print()
...
print(f"Saved velocity fluctuation plot → {OUTPUT_FIGS_DIR / 'velocity_fluctuation.png'}")
print()
...
contour = ax.contourf(
    x_grid, y_grid, velocity_magnitude,
    levels=20,
    cmap='viridis',
    alpha=0.7
)
...
print(f"Saved velocity vector field plot → {OUTPUT_FIGS_DIR / 'velocity_vector_field.png'}")
print()
...
fig.tight_layout(rect=[0, 0, 0.88, 0.96])  # leave room on right for colorbar, top for suptitle
...
print(f"Saved velocity field evolution plot → {OUTPUT_FIGS_DIR / 'velocity_field_evolution.png'}")
print()
